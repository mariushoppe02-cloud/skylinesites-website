          ...
          >
            ...
            <div className="flex flex-col">
              <span className="font-[var(--font-jakarta)] font-extrabold text-[28px] leading-tight tracking-tight">
                <span className="text-white">Skyline</span><span className="text-[#E8B84B]">Sites</span>
              </span>
              <span className="text-[8px] text-zinc-500 tracking-[0.3em] font-[var(--font-inter)] mt-1">WEB DESIGN AGENTUR</span>
            </div>
          </motion.div>
        </motion.div>
      )}
