...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 pointer-events-none">
      ...
      {/* Nur der Button ist der Link */}
      <a
        href="https://wa.me/491728191583"
        target="_blank"
      ...
      >
        ...
        <div className="relative w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-[0_4px_24px_rgba(37,211,102,0.45)] transition-all duration-300 group-hover:scale-110 group-hover:shadow-[0_6px_32px_rgba(37,211,102,0.65)] group-hover:bg-[#20b858]">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-7 h-7 transition-transform duration-300 group-hover:scale-105">
